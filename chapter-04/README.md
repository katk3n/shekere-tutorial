...
- `examples/04-interactive-patterns/`: 複合インタラクティブ効果

## 演習課題

- `exercises/exercise-01.md`: 基本的なマウス追従効果
- `exercises/exercise-02.md`: 距離計算の応用
- `exercises/exercise-03.md`: オリジナルインタラクティブパターン
