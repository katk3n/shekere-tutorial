...
**作品目標**: 「自然界の数学的パターンの発見 - Mathematical Patterns in Nature」

以下の4つの演習を段階的に進めることで、自然界に存在する美しい数学的パターンを発見し、最終的に複合的な作品を完成させます。各ステップでは前のステップのコードを継承・拡張して進めます：

### [演習1: 螺旋パターン「銀河の腕」](./exercises/01-spiral-patterns/)
**基礎**: length/atan2関数による螺旋パターンを作成
- Chapter 3特有の極座標系（距離・角度）による表現
- 銀河の渦巻き構造の数学的再現
- fract()による螺旋パターンの生成技術を習得

### [演習2: 格子パターン「結晶の格子構造」](./exercises/02-grid-patterns/)
**発展**: 前ステップの螺旋に格子パターンを追加
- 前ステップのコードを基礎として使用
- rotate_uv()カスタム関数とfract()による格子生成
- 螺旋パターンと格子パターンの調和的合成

### [演習3: ノイズ統合「秩序と混沌の調和」](./exercises/03-noise-integration/)
**複雑化**: ノイズパターンを追加して自然の不規則性を表現
- 前ステップの螺旋+格子パターンを基礎として使用
- pseudo_random()による疑似乱数生成の実装
- 規則性と不規則性の美しいバランス調整

### [演習4: 最終作品「自然の複合パターン」](./exercises/04-final-mathematical-cosmos/)
**完成**: 波動パターン・時間アニメーション・HSV色彩で作品を完成
- 前ステップの3パターンを基礎として使用
- 波動パターンの追加（Chapter 2との重複を避けて最終段階で導入）
- 時間による回転アニメーションとHSV色空間システム